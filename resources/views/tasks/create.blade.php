...
@section('content')
	...
	<div class="form-group">
		...
		{{ Form::text('status_id', Request::old('status_id'), array('class' => 'form-control' . ($errors->has('status_id') ? ' is-invalid' : ''))) }}
	...
	<div class="form-group">
		...
		{{ Form::text('responsible_person_id', Request::old('responsible_person_id'), array('class' => 'form-control' . ($errors->has('responsible_person_id') ? ' is-invalid' : ''))) }}
