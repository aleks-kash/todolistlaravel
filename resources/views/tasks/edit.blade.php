...
@section('content')
	...
	<div class="container">
		...
		<div class="form-group">
			...
			{{ Form::select('status_id', $statuses, null, array('class' => 'form-control' . ($errors->has('status_id') ? ' is-invalid' : ''))) }}
		...
		<div class="form-group">
			...
			{{ Form::select('responsible_person_id', $users, null, array('class' => 'form-control' . ($errors->has('responsible_person_id') ? ' is-invalid' : ''))) }}
